...
<head>\
    ...
    <style>\
        ...
        \
        .div1 { grid-area: 1 / 1 / 2 / 2; border: 50px solid transparent; border-top: 50px solid white; border-left: 50px solid white; }\
        .div2 { grid-area: 1 / 2 / 2 / 3; border: 50px solid transparent; border-bottom: 50px solid white; }\
        .div3 { grid-area: 1 / 3 / 2 / 4; border: 50px solid transparent; border-top: 50px solid white; border-top: 50px solid white; border-right: 50px solid white;}\
        ...
        .div7 { grid-area: 3 / 1 / 4 / 2; border: 50px solid transparent; border-bottom: 50px solid white; border-left: 50px solid white; }\
        .div8 { grid-area: 3 / 2 / 4 / 3; border: 50px solid transparent; border-top: 50px solid white; }\
        .div9 { grid-area: 3 / 3 / 4 / 4; border: 50px solid transparent; border-bottom: 50px solid white; border-right: 50px solid white; }\
    </style>\
</head>\
<body>\
    <div class=\"parent\">\
